...
!(function() {
  ...
  var I = H[u],
    ...
    _ = !1;
  c &&
    ((_ = (d.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      d.readyState
    )) ||
      ...
      var e = t.children,
        ...
        m = {
          ...
          children: [
            {
              tag: "path",
              attributes: E({}, s.attributes, c.path, { fill: "black" })
            }
          ]
        },
      ...
      return [
        {
          ...
          children: [
            { tag: "symbol", attributes: E({}, n, { id: o }), children: a }
          ]
        }
      ];
    };
  ...
  function it(t) {
    ...
    Q(n) &&
      ((y.transform =
        ((u = (c = { transform: n, startCentered: !0, width: r, height: a })
          .transform),
        (m = c.width),
        (d = void 0 === m ? C : m),
        (g = c.height),
  ...
  var ot = function() {},
    st =
      T.measurePerformance && l && l.mark && l.measure
        ? l
        : { mark: ot, measure: ot },
    lt = 'FA "5.3.1"',
    ft = function(t) {
  ...
  function xt(t) {
    return t.reduce(function(t, e) {
      ...
      if (yt[e]) t.prefix = e;
        ...
        var a =
          "fa" === t.prefix ? pt[r] || { prefix: null, iconName: null } : {};
        (t.iconName = a.iconName || r), (t.prefix = a.prefix || t.prefix);
      } else
        e !== T.replacementClass && 0 !== e.indexOf("fa-w-") && t.rest.push(e);
      return t;
    }, wt());
  }
  function kt(t, e, r) {
  ...
  var zt = {
    replace: function(t) {
      ...
      if (e.parentNode && e.outerHTML)
        e.outerHTML =
          r +
          (T.keepOriginalSource && "svg" !== e.tagName.toLowerCase()
            ? "\x3c!-- " + e.outerHTML + " --\x3e"
            : "");
    ...
    nest: function(t) {
      ...
      var n = r[0].attributes.class.split(" ").reduce(
        function(t, e) {
          return (
            e === T.replacementClass || e.match(a)
              ? t.toSvg.push(e)
              : t.toNode.push(e),
            t
          );
      ...
      var i = r
        ...
        .join("\n");
      e.setAttribute("class", n.toNode.join(" ")),
        e.setAttribute(A, ""),
        (e.innerHTML = i);
    }
  };
    ...
    0 === r.length
      ...
      : (m.requestAnimationFrame ||
          ...
          var t =
              !0 === T.autoReplaceSvg
                ? zt.replace
                : zt[T.autoReplaceSvg] || zt.replace,
            e = ct.begin("mutate");
          r.map(t), e(), a();
        });
  }
        ...
        St ||
          U(t).forEach(function(t) {
            if (
              ...
              "attributes" === t.type &&
                Nt(t.target) &&
                ~z.indexOf(t.attributeName))
            )
              if ("class" === t.attributeName) {
                var e = xt(V(t.target)),
                  r = e.prefix,
                  a = e.iconName;
                r && t.target.setAttribute("data-prefix", r),
  ...
  var jt = function(t) {
      ...
      return (
        ...
        o.prefix && 1 < i.length
          ...
          : o.prefix &&
            1 === i.length &&
            (o.iconName = bt(o.prefix, Pt(t.innerText))),
        o
      );
    },
    Rt = function(t) {
    ...
    It = function(t) {
      ...
      return (
        T.autoA11y &&
          (r
            ? (e["aria-labelledby"] = T.replacementClass + "-title-" + q())
            : (e["aria-hidden"] = "true")),
        e
      );
    },
      ...
      children: [
        Wt,
        {
          ...
          children: [
            ...
            {
              tag: "animate",
              attributes: E({}, Xt, { values: "1;0;1;1;0;1;" })
            }
          ]
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: E({}, Xt, { values: "1;0;0;0;0;1;" })
            }
          ]
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: E({}, Xt, { values: "0;0;1;1;0;0;" })
            }
          ]
        }
      ]
  ...
  function Qt(t, e) {
    ...
    } else if (t && e && !T.showMissingIcons)
      throw new Yt("Icon is missing for prefix " + e + " with icon name " + t);
    return r;
  }
  function Zt(t) {
    var e,
        ...
        L(t, [
          {
            ...
            value: function() {
              for (
                var e = this, t = arguments.length, r = Array(t), a = 0;
                a < t;
                a++
              )
                r[a] = arguments[a];
        ...
        return ie({ type: "layer" }, function() {
          ...
          return (
            ...
            [
              {
                tag: "span",
                attributes: { class: T.familyPrefix + "-layers" },
                children: e
              }
            ]
          );
